    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-24 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-sm text-textmuted mb-6">
          Enter the code sent to <span className="text-textmain">{email || 'your email'}</span> and choose a new password.
        </p>
        ...
        {success && (
          <div className="mb-4 flex items-center gap-2 px-4 py-2.5 rounded-lg bg-primary/10 border border-primary/30 text-primary text-sm">
